...
export function Sidebar() {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          'h-screen bg-white dark:bg-slate-900 border-r border-slate-200 dark:border-slate-800 flex flex-col transition-transform duration-300 ease-in-out',
          'w-64',
      ...
      >
        <div className="p-3 border-b border-slate-200 dark:border-slate-800 flex items-center justify-between">
          <Link
            ...
            onClick={closeSidebar}
          >
            <div className="w-8 h-8 bg-slate-200 dark:bg-slate-700 rounded-sm flex items-center justify-center" aria-hidden="true">
              <LayoutDashboard className="w-4 h-4 text-slate-950 dark:text-slate-100" />
            </div>
            <span className="text-sm font-semibold text-slate-950 dark:text-slate-100 tracking-tight">MatchPulse</span>
          </Link>
          <button
            onClick={closeSidebar}
            className="lg:hidden p-2 rounded-sm hover:bg-slate-100 dark:hover:bg-slate-700 transition-colors"
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  isActive
                    ? 'bg-slate-100 dark:bg-slate-700 text-slate-950 dark:text-slate-100'
        ...
        <div className="p-3 border-t border-slate-200 dark:border-slate-800">
          <Link
            href="/login"
            className="flex items-center gap-2 px-2 py-2 rounded-sm text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-700 hover:text-slate-950 dark:hover:text-slate-100 transition-all duration-200 group"
