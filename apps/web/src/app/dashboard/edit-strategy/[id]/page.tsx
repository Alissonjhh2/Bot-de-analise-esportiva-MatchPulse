...
export default function EditStrategyPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await apiClient.put(`/strategies/${strategyId}`, {
        name,
        startMinute,
        endMinute,
        conditions,
    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        ...
        >
          ...
          />
          <p className="text-gray-600 dark:text-gray-400">Carregando estratégia...</p>
        </motion.div>
      </div>
    );
  }
        ...
        {step === 4 && (
          ...
          >
            <Card className="border-0 shadow-xl hover:shadow-2xl transition-all duration-300">
              ...
              <CardContent className="p-8 space-y-6">
              <div className="p-6 bg-gradient-to-br from-blue-50 to-white dark:from-blue-900/10 dark:to-gray-800 rounded-xl border border-blue-100 dark:border-blue-900/30">
              ...
              <div className="p-6 bg-gradient-to-br from-green-50 to-white dark:from-green-900/10 dark:to-gray-800 rounded-xl border border-green-100 dark:border-green-900/30">
                <h4 className="font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-2">
